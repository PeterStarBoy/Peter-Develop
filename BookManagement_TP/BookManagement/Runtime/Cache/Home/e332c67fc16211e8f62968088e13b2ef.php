...
<link href="__SOURCE__/css/style.css" rel="stylesheet">
...
<form name="form1" method="post" action="/index.php/home/index/checkLogin">
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
      ...
      <td width="28%" background="__SOURCE__/Images/bg.gif"><table width="603" height="243"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolorlight="#FFFFFF" bordercolordark="#D2E3E6">
        <tr>
