...
<link href="/BookManagement/Public/Home/css/style.css" rel="stylesheet">
...
<p>&nbsp;</p>
<p>&nbsp;</p>
<form name="form1" method="post" action="/index.php/Home/Index/checkLogin">
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="30%" bgcolor="86C1E6">&nbsp;</td>
      <td width="28%" background="/BookManagement/Public/Home/image/bg.gif"><table width="603" height="243"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolorlight="#FFFFFF" bordercolordark="#D2E3E6">
        <tr>
        ...
        <tr>
          <td height="30" align="center">管理员名称：
            <input name="username" type="text" class="logininput" id="name3" size="25"></td>
          <td height="30" valign="top">&nbsp;</td>
        </tr>
        <tr>
          <td height="30" align="center">管理员密码：
            <input name="password" type="password" class="logininput" id="pwd2" size="25"></td>
          <td height="30" valign="top">&nbsp;</td>
        </tr>
        <tr>
