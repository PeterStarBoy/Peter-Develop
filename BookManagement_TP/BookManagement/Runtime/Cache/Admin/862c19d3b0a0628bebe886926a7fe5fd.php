...
$(function () {
	$('#typename').on('blur', function () {
		...
		if (name != '')
		{
			$.get('/index.php/Admin/Readertype/ifexists', { name : name }, function (data) {
				if (data)
				{
					$('#msg').text(data);
				} 
  ...
  <tr>
	...
	<table height="100"  border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
      <tr>
        ...
        <td width="191" height="39"><input name="name" id='typename' type="text" size="28"></td>
      </tr>
	  <tr align='center'><td colspan=2><span id='msg' style='color:red'>&nbsp;</span></td></tr>
      <tr>
