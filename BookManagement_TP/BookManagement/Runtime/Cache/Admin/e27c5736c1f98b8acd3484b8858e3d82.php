...
<table width="776" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td height="510" valign="top" style="padding:5px;"><table width="98%" height="487"  border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
		...
		<?php if(empty($types)): ?><table width="100%" height="30"  border="0" cellpadding="0" cellspacing="0">
            <tr>
 ...
 <table width="91%"  border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="right">      
      <a href="#" onClick="window.open('/index.php/Admin/Readertype/typeAdd','','width=292,height=175')">添加读者类型信息</a> </td>
</tr>
</table>  
  ...
  <tr align="center" bgcolor="#e3F4F7">
	...
	<?php if(is_array($types)): $i = 0; $__LIST__ = $types;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$valtypes): $mod = ($i % 2 );++$i;?><tr>
    <td style="padding:5px;" align = 'center'>&nbsp;<?php echo ($valtypes['name']); ?></td>
    <td style="padding:5px;" align = 'center'>&nbsp;<?php echo ($valtypes['number']); ?></td>
    <td align="center"><a href="/index.php/Admin/Readertype/typeDel/id/<?php echo ($valtypes['id']); ?>">删除</a></td>
  </tr><?php endforeach; endif; else: echo "" ;endif; endif; ?>
	<tr align = 'center'><td colspan = 3>&nbsp;</td></tr>
	<tr align = 'center'><td colspan = 3><?php echo ($show); ?></td></tr>
	</table></td>
      </tr>
    </table>
</td>
