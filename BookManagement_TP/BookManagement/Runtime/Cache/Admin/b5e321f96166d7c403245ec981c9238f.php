...
<p>&nbsp;</p>
<p>&nbsp;</p>
<form name="form1" method="post" action="/index.php/Admin/Public/checkLogin">
  <table width="100%"  border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td width="30%" bgcolor="86C1E6">&nbsp;</td>
      <td width="28%" background="/BookManagement/Public/Admin/image/bg.gif"><table width="603" height="243"  border="0" align="center" cellpadding="0" cellspacing="0" bordercolorlight="#FFFFFF" bordercolordark="#D2E3E6">
        <tr>
